...
// function printCancelledList(collegeName: string, dateFrom: string, dateTo: string, rows: CancelledReceiptRow[]) {
//   const printWindow = window.open("", "_blank", "width=1000,height=1000");
//   if (!printWindow) {
//     window.alert("Your browser blocked the print popup. Please allow popups for this site and try again.");
//     return;
//   }

//   const total = rows.reduce((s, r) => s + (Number(r.Credit) || 0), 0);

//   const rowsHtml = rows
//     .map(
//       (r) => `
//       <tr>
//         <td>${escapeHtml(formatDDMMYYYY(r.CancelledDate))}</td>
...
//   <head>
//     <meta charset="utf-8" />
//     <title>Cancelled Receipts</title>
//     <style>
...
//       .report-college { font-weight: bold; font-size: 15px; }
//       .report-title { font-weight: bold; font-size: 13px; margin-top: 4px; }
...
//       th { background: #eee; }
//       .report-totals { margin-top: 12px; font-weight: bold; font-size: 12px; text-align: right; }
...
//       <div class="report-title">Cancelled Receipts Report</div>
//     </div>
...
//     </table>
//     <div class="report-totals">Total Cancelled Amount : ${total.toFixed(2)}</div>
//   </body>
// </html>`;
...
//   const [selectedReceipt, setSelectedReceipt] = useState<SearchedReceipt | null>(null);
...
//   useEffect(() => {
//     dispatch(getCancelReceiptOptions());
//   }, [dispatch]);
...
//     if (!selectedReceipt) {
//       window.alert("Please select a receipt from the results first.");
//       return;
//     }
//     if (!comments.trim()) {
//       window.alert("Please specify comment to cancel Receipt");
//       return;
//     }
...
//           collegeName: selectedReceipt.CollegeName,
//           ledgerName: selectedReceipt.LedgerName,
//           session: selectedReceipt.Session,
//           idNo: selectedReceipt.IDNo,
//           studentName: selectedReceipt.StudentName,
//           credit: selectedReceipt.Credit,
...
//     try {
//       const result = await dispatch(
//         getCancelledReceiptsList({ collegeName, dateFrom, dateTo })
//       ).unwrap();
...
//       window.alert("No records to print. Click Display first.");
//       return;
//     }
...
//                       selectedReceipt?.TransactionID === row.TransactionID
//                         ? "bg-blue-100"
//                         : i % 2 === 0
//                         ? "bg-white"
//                         : "bg-gray-50"
...
//           </span>
//           <HeaderButton onClick={handleAddToCancelled} disabled={cancelling || !selectedReceipt}>
...
//               <thead className="sticky top-0 bg-gray-200">
//                 <tr>
//                   <th className="border border-gray-300 px-2 py-1 text-left">Cancelled Date</th>
//                   <th className="border border-gray-300 px-2 py-1 text-left">Receipt No</th>
//                   <th className="border border-gray-300 px-2 py-1 text-left">Ledger Name</th>
//                   <th className="border border-gray-300 px-2 py-1 text-left">ID No</th>
//                   <th className="border border-gray-300 px-2 py-1 text-left">Student Name</th>
...
//                     <td className="border border-gray-300 px-2">
//                       {formatDDMMYYYY(row.CancelledDate)}
//                     </td>
//                     <td className="border border-gray-300 px-2">{row.ReceiptNo}</td>
//                     <td className="border border-gray-300 px-2">{row.LedgerName}</td>
//                     <td className="border border-gray-300 px-2">{row.IDNo}</td>
